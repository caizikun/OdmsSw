...
public partial class ProgressForm : Form
{
	...
	private void timer1_Tick(object sender, EventArgs e)
	{
		...
		else
		{
			...
			try
			{
				//edited by DrBae 2015-10-01 : 
				int valueToProgress = (int)(totalTimes - remainTime.TotalSeconds);
				if (valueToProgress > statusProgressBar.Maximum)
					statusProgressBar.Value = statusProgressBar.Maximum;
				else statusProgressBar.Value = valueToProgress;				
