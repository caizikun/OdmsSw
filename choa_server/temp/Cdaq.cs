...
public class DaqChoa : IDisposable
{
    #region definition
    ...
    public bool CreateAiCh(int _aiNo, double _min, double _max)
    {
        ...
        try
        {
            ...
            if (aiCh.Create(_aiNo, _min, _max) == false)
            ...
            //add it to list.
            if (m_aiSingList == null)
                m_aiSingList = new List<CaiChannel>();
    ...
    /// <summary>
    /// digital input 채널을 만들고 
    /// (terminal configuration :  Referenced Single-End )
    /// task를 Start시킨다.
    /// </summary>
    /// <param name="_aiNo">analog input no.</param>
    /// <returns></returns>
    public bool CreateAiChRse(int _aiNo, double _min, double _max)
    {
        ...
        try
        {
            ...
            //create digital input channel instance.
            CaiChannel aiCh = new CaiChannel();
            if (aiCh.CreateRse(_aiNo, _min, _max) == false)
                throw new ApplicationException();
    ...
    /// <summary>
    /// digital input 채널을 만들고 (single line)
    /// task를 Start시킨다.
    /// </summary>
    ...
    public bool CreateDiCh(int _lineNo)
    {
        ...
        try
        {
            ...
            if (diSingChnl.Create(_lineNo) == false)
                throw new ApplicationException();
    ...
    /// <summary>
    /// digital input 채널을 만들고 (multi lines)
    /// task를 Start시킨다.
    /// </summary>
    /// <param name="_lines">line no. array.</param>
    /// <returns></returns>
    public bool CreateDiCh(int[] _lines)
    {
        ...
        try
        {
            ...
            if (diMultiChnl.Create(_lines) == false)
                throw new ApplicationException();


            //add it to list.
            if (m_diMultiChList == null)
                m_diMultiChList = new List<CdiMultiLineChannel>();
    ...
    /// <summary>
    /// digital input 채널을 만들고 (single lines)
    /// task를 Start시킨다.
    /// </summary>
    /// <param name="_line">line no.</param>
    /// <returns></returns>
    public bool CreateDoCh(int _line)
    {
        ...
        try
        {
            ...
            if (doSingChnl.Create(_line) == false)
                throw new ApplicationException();
    ...
    public bool CreateDoCh(string _lineStr)
    {
        ...
        try
        {
            ...
            if (doMultiChnl.Create(_lineStr) == false)
                throw new ApplicationException();
