...
public partial class ProgressForm : Form
{
    ...
    public static ProgressForm mLastForm; 
    ...
    public ProgressForm()
    {
        ...
        if (mLastForm != null) mLastForm.Close();
        mLastForm = this;
    }
    ...
    private void frmProcessRes_Load(object sender, EventArgs e)
    {
        ...
        //option & configs.
        string confFilepath = Application.StartupPath + "\\config\\conf_processRes.xml";
    ...
    private void timer1_Tick(object sender, EventArgs e)
    {
        if (m_pr.compeleted == true)
        {
            ...
            lbProcessTime.Text = String.Format("{0:D2}:{1:D2}:{2:D2}",
                                               durTime.Hours,
                                               durTime.Minutes,
                                               durTime.Seconds);
        ...
        else
        {
            ...
            lbRemainTime.Text = String.Format("{0:D2}:{1:D2}:{2:D2}", 
                                              remainTime.Hours,
                                              remainTime.Minutes,
                                              remainTime.Seconds);
            ...
            lbProcessTime.Text = String.Format("{0:D2}:{1:D2}:{2:D2}", 
                                               ...
                                               durTime.Minutes,
                                               durTime.Seconds);
            if (txtMessage.Text != m_pr.msg) txtMessage.Text = m_pr.msg;

            //progress
            statusProgressBar.Minimum = 0;
            if (statusProgressBar.Maximum != totalTimes) statusProgressBar.Maximum = totalTimes;
    ...
    /// form을 마무리 한다.
    /// </summary>
    private void frmProcessRes_FormClosing(object sender, FormClosingEventArgs e)
    {
    ...
    /// </summary>
    /// <param name="pr"></param>
    public void SetProcData(CprogRes pr)
    {
