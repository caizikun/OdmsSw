...
class Ctsl510 : Itls
{
    ...
    private const int DEFAULT_SWEEPSPEED = 50;          //[nm/s]
    ...
    public bool ConnectByGpib(int _gpib)
    {
        ...
        try
        {
            ret = m_sanTls.ConnectByGpib(_gpib);
        }
        catch
        {
            ret = false;
    ...
    public bool Init()
    {
        ...
        try
        {
            m_sanTls.SetSweepCycle(SWEEP_CYCLE);

            m_sanTls.SetSweepSpeed(DEFAULT_SWEEPSPEED);

            m_sanTls.SetPwrUnitDBm();
            m_sanTls.LaserOn();
            m_sanTls.SetTrigOutModeStep();
    ...
    public void SetTlsSweepRange(int _start, int _stop, double _step)
    {
        ...
        try
        {
            m_sanTls.SetSweepRange(_start, _stop, _step);
            m_sanTls.SetTrigOutModeStep();
    ...
    public void GetTlsSweepRange(ref int _start, ref int _stop, ref double _step)
    {
        ...
        try
        {
            m_sanTls.GetSweepRange(ref _start, ref _stop, ref _step);
        }
        catch
        {
            _start = 0;
